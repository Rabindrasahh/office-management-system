...
<div id="wrapper">
           ...
           <ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="employee_form">
                        <i class="fas fa-fw fa-chart-area"></i>
                        <span>Add Task</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="show_data">
                        <i class="fas fa-fw fa-chart-area"></i>
                        ...
                        <ul class="navbar-nav ml-auto">
                                ...
                                <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="messagesDropdown">
                                    ...
                                    <a class="dropdown-item d-flex align-items-center" href="#">
                                        <div class="dropdown-list-image mr-3">
                                            <img class="rounded-circle" src="{{asset('panel-css/img/man.png')}}" style="max-width: 60px;" alt="" />
                                    ...
                                    <a class="dropdown-item d-flex align-items-center" href="#">
                                        <div class="dropdown-list-image mr-3">
                                            <img class="rounded-circle" src="{{asset('panel-css/img/girl.png')}}" style="max-width: 60px;" alt="" />
                            ...
                            <li class="nav-item dropdown no-arrow">
                                <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <img class="img-profile rounded-circle" src="{{asset('panel-css/img/boy.png')}}" style="max-width: 60px;" />
